    ...
    public partial class final1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreMaps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GenreMaps_Genres_GenreId",
                        column: x => x.GenreId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GenreMaps_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GenreMaps_Series_SeriesId",
                        column: x => x.SeriesId,
                        principalTable: "Series",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlatformMaps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlatformMaps_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PlatformMaps_Platforms_PlatformId",
                        column: x => x.PlatformId,
                        principalTable: "Platforms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlatformMaps_Series_SeriesId",
                        column: x => x.SeriesId,
                        principalTable: "Series",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenreMaps_GenreId",
                table: "GenreMaps",
                column: "GenreId");

            migrationBuilder.CreateIndex(
                name: "IX_GenreMaps_MovieId",
                table: "GenreMaps",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_GenreMaps_SeriesId",
                table: "GenreMaps",
                column: "SeriesId");

            migrationBuilder.CreateIndex(
                name: "IX_PlatformMaps_MovieId",
                table: "PlatformMaps",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_PlatformMaps_PlatformId",
                table: "PlatformMaps",
                column: "PlatformId");

            migrationBuilder.CreateIndex(
                name: "IX_PlatformMaps_SeriesId",
                table: "PlatformMaps",
                column: "SeriesId");
